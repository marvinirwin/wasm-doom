...
var Module = typeof WasmDoom !== 'undefined' ? WasmDoom : {};
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 6131824,
    DYNAMIC_BASE = 6131824,
    DYNAMICTOP_PTR = 888656;
...
var wasmBinaryFile = '/wasm-doom.wasm';
...
var ASM_CONSTS = [function($0, $1, $2, $3, $4, $5, $6) { initByteLocation( $0, $1, $2, $3, $4, $5, $6); }];
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=888704;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
...
if (typeof exports === 'object' && typeof module === 'object')
      module.exports = WasmDoom;
    else if (typeof define === 'function' && define['amd'])
      define([], function() { return WasmDoom; });
    else if (typeof exports === 'object')
      exports["WasmDoom"] = WasmDoom;
